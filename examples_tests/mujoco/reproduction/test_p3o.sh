...
python examples/mujoco/reproduction/p3o/train_p3o.py --steps 10 --update-interval 5 --batch-size 5 --epochs 2 --outdir $outdir/mujoco/reproduction/ppo --env Pendulum-v0 --gpu $gpu
