...
class P3O(agent.AttributeSavingMixin, agent.BatchAgent):
    """Proximal Performance Policy Optimization
    ...
    def __init__(
        ...
        # Batch versions of last_episode, last_state, last_action, and episodic_return
