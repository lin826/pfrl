"""A training script of P3O on OpenAI Gym Mujoco environments.
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Number of epochs to update model for per P3O iteration.",
    )
    ...
    if args.load or args.load_pretrained:
        ...
        if args.load:
            ...
            agent.load(utils.download_model("P3O", args.env, model_type="final")[0])
